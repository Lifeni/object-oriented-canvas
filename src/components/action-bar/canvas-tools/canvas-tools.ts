    ...
    constructor() {
        ...
        shadowRoot.innerHTML = `
            <section>
                ...
                <tool-button icon="square" tooltip="方形" type="rectangle" focusable="true" property="true"></tool-button>
                ...
                <tool-button icon="share" tooltip="协作" type="share" focusable="true" property="true"></tool-button>
